...
Player::Player(GameObject* parent)
	:GameObject(parent,"Player"),hModel_(-1), Ground_(0),isMove_(true)
{
	jumpSpeed_ = 0.0f;
}
...
void Player::Initialize()
{
	...
	//上下左右の当たり判定
	PboxColl[0] = new BoxCollider({ 0.5,0.1,0 }, { 0.3,1.0,0.1 });//右
	//PboxColl[0] = new BoxCollider({ 0,0.2,0 }, { 0.8,1.1,0.5 });//左
